...
public class loginform extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try{
            String qry;
            //qry="SELECT * FROM vj WHERE uname = '"+jTextField1.getText()+"' AND upass = '"+jPasswordField1.getText()+"'";         
            qry = "select * from vj where uname = '"+jTextField1.getText()+"' && upass = '"+jPasswordField1.getText()+"';";
